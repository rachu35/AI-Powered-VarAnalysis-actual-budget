...
JOIN budget b ON a.account_code=b.account_code AND a.dept_code=b.dept_code AND a.month=b.month
JOIN chart_of_accounts c ON a.account_code=c.account_code
WHERE a.dept_code='HW' AND a.month='2025-12-01'

UNION ALL

SELECT NULL,NULL,NULL,NULL,NULL,'Operating Profit (Incl GA)',252859,146912
```
...
Below is the December 2025 financial data for the Health & Wellness (HW) department, including the specific reasons behind notable variances:
...
### 🌱 Prompt Template (2)
- Template: `CALL upsert_ai_summary('HW', '2025-12-01', '{summary}');`
...
### 💧 Change monthly parts
  - `WHERE a.dept_code='BT' AND a.month='2025-12-01'`
  - `'Operating Profit (Incl GA)',577167,219045`
  - Prompt Template text: "December 2025" → update to the new month
